    ...
    return sdk.checkoutPost({}, {
      ...
      .then((response) => {
        ...
        if (data.message) {
          ...
          insertResponseMessage('Oops, something went wrong1. Please try again.');
        }
      })
      .catch((error) => {
    ...
    callNluApi(msg)
      .then((response) => {
        ...
        if (data.messages && data.messages.length > 0) {
          ...
          insertResponseMessage('Oops, something went wrong2. Please try again.');
        }
      })
      .catch((error) => {
        console.log('an error occurred', error);
        insertResponseMessage('Oops, something went wrong3. Please try again.');
      });
  }
